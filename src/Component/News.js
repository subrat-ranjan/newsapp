...
export class News extends Component {
  ...
  async updateNews() {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apikey=086a87a3c5104d8c9bf6142b7b574f1b&page=${this.state.page}&pageSize=${this.props.pageSize}`;
  ...
  //     }&apikey=086a87a3c5104d8c9bf6142b7b574f1b&page=${this.state.page - 1
          ...
          <div className="row justify-content-between">

            {
              this.state.articles.map((element) => {
                return (
                  <div
                    className="col-md-3  mx-4 mb-5" key={element.url}>
                    <NewsItems
